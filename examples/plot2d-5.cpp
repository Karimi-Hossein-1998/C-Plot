...
int main()
{
    ...
    Plot2DData pd(xs,ys,LineStyle::Solid, "#0000ff", 5, 0.9);
    ...
    Plot2DData pd2(xs,ys,LineStyle::Solid, "#ff0000", 5, 0.8);
    ...
    Plot2DData pd3(xs,ys,LineStyle::Solid, "#00ff00", 5, 0.7);
    ...
    plot.addData(xs,ys,LineStyle::DashDot, "#007f7f", 5, 0.6);
