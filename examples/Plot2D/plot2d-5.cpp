...
int main()
{
    ...
    Plot2DData pd(xs,ys,LineStyle::Solid, 0, 0, 255, 5, 0.9);
    ...
    Plot2DData pd2(xs,ys,LineStyle::Solid, 255, 0, 0, 5, 0.8);
    ...
    Plot2DData pd3(xs,ys,LineStyle::Solid, 0, 255, 0, 5, 0.7);
    ...
    plot.addData(xs,ys,LineStyle::DashDot, 0, 127, 127, 5, 0.6);
    std::string filename = "test-5.svg";
