...
int main()
{
    ...
    data.push_back(PlotPolarData(rs,ts,true,1.0,5.0,0.7,0.6,63,63,63,255,0,0,""));
    rs = {};
    ts = {};
    for( size_t i=0; i<200; ++i )
    {
    ...
    data.push_back(PlotPolarData(rs,ts,true,1.0,5.0,0.6,0.5,31,31,63,0,255,0,""));
    rs = {};
    ts = {};
    for( size_t i=0; i<200; ++i )
    {
    ...
    data.push_back(PlotPolarData(rs,ts,true,1.0,5.0,0.5,0.4,127,127,255,31,31,31,""));
    // plot.forceRMax(1.0);
    ...
    std::string filename = "pp-test-3.svg";
